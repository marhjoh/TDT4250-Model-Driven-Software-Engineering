...
public class LeagueHandlerDSL {
  ...
  private final Map<Team, LeagueHandlerDSL.TeamStatistics> teamStatsMap = new HashMap<Team, LeagueHandlerDSL.TeamStatistics>();
  ...
  public void handleTournament(final Tournament tournament) {
    ...
    final Consumer<Team> _function = (Team team) -> {
      ...
      LeagueHandlerDSL.TeamStatistics _teamStatistics = new LeagueHandlerDSL.TeamStatistics(_name_1);
  ...
  public void updateTeamStatistics(final Team team, final int goalsScored, final int goalsConceded, final int pointsForWin, final int pointsForDraw, final int pointsForLoss) {
    final LeagueHandlerDSL.TeamStatistics stats = this.teamStatsMap.get(team);
  ...
  public void generateTournamentResults() {
    InputOutput.<String>println("\nFinal Standings:");
    Collection<LeagueHandlerDSL.TeamStatistics> _values = this.teamStatsMap.values();
    final ArrayList<LeagueHandlerDSL.TeamStatistics> sortedTeams = new ArrayList<LeagueHandlerDSL.TeamStatistics>(_values);
    final Comparator<LeagueHandlerDSL.TeamStatistics> _function = (LeagueHandlerDSL.TeamStatistics t1, LeagueHandlerDSL.TeamStatistics t2) -> {
      return Integer.compare(t2.points, t1.points);
    };
    Collections.<LeagueHandlerDSL.TeamStatistics>sort(sortedTeams, _function);
    final Consumer<LeagueHandlerDSL.TeamStatistics> _function_1 = (LeagueHandlerDSL.TeamStatistics stats) -> {
