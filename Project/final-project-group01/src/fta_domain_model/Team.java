 ...
 *   <li>{@link fta_domain_model.Team#getTeamID <em>Team ID</em>}</li>
 * </ul>
 *
 * @see fta_domain_model.Fta_domain_modelPackage#getTeam()
 * @model annotation="teamConstraint teamSizeConstraint='self.players-&gt;size() &gt;= 2' teamTotalGoalsConstraint='self.players-&gt;collect(player | player.playerstatistics.goals)-&gt;sum()'"
 * @generated
 */
public interface Team extends EObject {
	 ...
	 * @see #setTeamID(int)
	 * @see fta_domain_model.Fta_domain_modelPackage#getTeam_TeamID()
	 * @model default="0" id="true" required="true" derived="true"
	 * @generated
	 */
	int getTeamID();

	/**
	 * Sets the value of the '{@link fta_domain_model.Team#getTeamID <em>Team ID</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
