...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Knockout</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link fta_domain_model.impl.KnockoutImpl#getNumberOfRounds <em>Number Of Rounds</em>}</li>
 *   <li>{@link fta_domain_model.impl.KnockoutImpl#isHasThirdPlacePlayoff <em>Has Third Place Playoff</em>}</li>
 * </ul>
 *
 * @generated
 */
public class KnockoutImpl extends TournamentFormatImpl implements Knockout {
	/**
	...
	protected EClass eStaticClass() {
		return Fta_domain_modelPackage.Literals.KNOCKOUT;
	}
	...
	public void setNumberOfRounds(int newNumberOfRounds) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Fta_domain_modelPackage.KNOCKOUT__NUMBER_OF_ROUNDS,
	...
	public void setHasThirdPlacePlayoff(boolean newHasThirdPlacePlayoff) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Fta_domain_modelPackage.KNOCKOUT__HAS_THIRD_PLACE_PLAYOFF, oldHasThirdPlacePlayoff,
