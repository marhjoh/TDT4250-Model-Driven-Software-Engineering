...
public class TournamentItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Fta_domain_modelPackage.Literals.TOURNAMENT__TEAMS);
			childrenFeatures.add(Fta_domain_modelPackage.Literals.TOURNAMENT__TOURNAMENTFORMAT);
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(Fta_domain_modelPackage.Literals.TOURNAMENT__TEAMS,
				Fta_domain_modelFactory.eINSTANCE.createTeam()));

		newChildDescriptors.add(createChildParameter(Fta_domain_modelPackage.Literals.TOURNAMENT__TOURNAMENTFORMAT,
				Fta_domain_modelFactory.eINSTANCE.createLeague()));

		newChildDescriptors.add(createChildParameter(Fta_domain_modelPackage.Literals.TOURNAMENT__TOURNAMENTFORMAT,
				Fta_domain_modelFactory.eINSTANCE.createRoundRobin()));

		newChildDescriptors.add(createChildParameter(Fta_domain_modelPackage.Literals.TOURNAMENT__TOURNAMENTFORMAT,
				Fta_domain_modelFactory.eINSTANCE.createKnockout()));
