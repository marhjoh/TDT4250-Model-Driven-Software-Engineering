...
/**
 * This is the item provider adapter for a {@link fta_domain_model.League} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LeagueItemProvider extends TournamentFormatItemProvider {
	/**
	...
	protected void addNumberOfRoundsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_League_numberOfRounds_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_League_numberOfRounds_feature",
								"_UI_League_type"),
						Fta_domain_modelPackage.Literals.LEAGUE__NUMBER_OF_ROUNDS, true, false, false,
	...
	protected void addFinalsFormatPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_League_finalsFormat_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_League_finalsFormat_feature",
								"_UI_League_type"),
						Fta_domain_modelPackage.Literals.LEAGUE__FINALS_FORMAT, true, false, false,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_League_type")
