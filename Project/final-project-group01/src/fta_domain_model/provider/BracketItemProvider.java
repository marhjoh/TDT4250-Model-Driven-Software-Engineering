...
public class BracketItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addBracketIDPropertyDescriptor(object);
			addNumberOfMatchesPropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the Bracket ID feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addBracketIDPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Bracket_bracketID_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Bracket_bracketID_feature",
								"_UI_Bracket_type"),
						Fta_domain_modelPackage.Literals.BRACKET__BRACKET_ID, false, false, false,
						ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
	}

	/**
	 * This adds a property descriptor for the Number Of Matches feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addNumberOfMatchesPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Bracket_numberOfMatches_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Bracket_numberOfMatches_feature",
								"_UI_Bracket_type"),
						Fta_domain_modelPackage.Literals.BRACKET__NUMBER_OF_MATCHES, true, false, false,
						ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
	}
	...
	public String getText(Object object) {
		...
		return getString("_UI_Bracket_type") + " " + bracket.getBracketID();
	}
