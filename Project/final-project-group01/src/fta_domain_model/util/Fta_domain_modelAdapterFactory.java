...
public class Fta_domain_modelAdapterFactory extends AdapterFactoryImpl {
	...
	protected Fta_domain_modelSwitch<Adapter> modelSwitch = new Fta_domain_modelSwitch<Adapter>() {
		...
		@Override
		public Adapter caseKnockout(Knockout object) {
			return createKnockoutAdapter();
		}
	...
	/**
	 * Creates a new adapter for an object of class '{@link fta_domain_model.League <em>League</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link fta_domain_model.Knockout <em>Knockout</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link fta_domain_model.Attacker <em>Attacker</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
