...
public class RoundRobinImpl extends TournamentFormatImpl implements RoundRobin {
	 ...
	 * @ordered
	 */
	protected static final String TIE_BREAKER_RULE_EDEFAULT = "";
	 ...
	 * @ordered
	 */
	protected String tieBreakerRule = TIE_BREAKER_RULE_EDEFAULT;
	 ...
	 */
	@Override
	public void setTieBreakerRule(String newTieBreakerRule) {
		String oldTieBreakerRule = tieBreakerRule;
	...
	public void eSet(int featureID, Object newValue) {
		...
		case Fta_domain_modelPackage.ROUND_ROBIN__NUMBER_OF_ROUNDS:
			...
			return;
		case Fta_domain_modelPackage.ROUND_ROBIN__TIE_BREAKER_RULE:
			setTieBreakerRule((String) newValue);
			return;
		}
	...
	public boolean eIsSet(int featureID) {
		...
		case Fta_domain_modelPackage.ROUND_ROBIN__TIE_BREAKER_RULE:
			return TIE_BREAKER_RULE_EDEFAULT == null ? tieBreakerRule != null
					: !TIE_BREAKER_RULE_EDEFAULT.equals(tieBreakerRule);
		}
